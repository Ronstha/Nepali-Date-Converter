...
char bsmonth[12][30]={"Baisakh","Jestha","Asar","Sharwan","Bhadra","Ashoj","Karthik","Mangsir","Paush","Magh","Falgun","Chaitra"};
char admonth[12][30]={"January","Februry","March","April","May","June","July","August","September","October","November","December"};
char weekdays[7][30]={"Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"};
...
Date format(char raw[]){
 ...
 Date Bs2Ad(char raw[]){
    ...
    strcpy(convert.Day,weekdays[convert.weekday-1]);
    ...
    while (daycount>0){
        if(daycount>ad[convert.month-1]){
            ...
            strcpy(convert.Month,admonth[convert.month-1]);
            break;
        }
    }
    return convert;
  ...
  Date convert;
    ...
    while (daycount>0){
        if(daycount>bs[convert.year-2000][convert.month-1]){
            ...
            strcpy(convert.Month,bsmonth[convert.month-1]);
            convert.day=daycount;
            break;
        }
    }
